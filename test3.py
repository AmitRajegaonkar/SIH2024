                ...
                try:
                    if flag:
                        ...
                        with open("frame.jpg",'rb') as f:
                            response = s.post("http://localhost:8055/files",headers=headers,files={"file":("image.jpg", f, "image/jpeg")},data={"folder":"e23d691c-b205-4b75-9bd8-fb7693827857"}).json()['data']
                            print(response['id'])
